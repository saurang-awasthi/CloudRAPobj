CLASS zcl_ce_rap_agency_ext DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zz_travel_agency_es5_ext-agencyid.
    TYPES t_business_data TYPE TABLE OF zz_travel_agency_es5_EXT.
...
CLASS zcl_ce_rap_agency_ext IMPLEMENTATION.
 ...
 METHOD if_oo_adt_classrun~main.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_TRAV_AW02_E' ).
